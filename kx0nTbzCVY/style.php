...
ul.breadcrumbs li a {
    background:url(images/crumbs.png) no-repeat right 7px;
    display:block;
...
.date95 {
	...
	text-indent: 23px;
	background: url("images/wo.jpg") no-repeat 0px 3px;
...
.date951 {
	...
	text-indent: 27px;
	background: url("images/wo1.jpg") no-repeat 0px 1px;
...
.li1{margin:10px 0px 0px 10px;font-size:12px;line-height:20px}
.li2{margin:5px 0px 0px 30px;font-size:12px;line-height:20px}
...
body{background:#efefef url(images/pattern2.png) repeat top left;font-size:12px;line-height:20px;font-family:Trebuchet MS,sans-serif;padding:0;margin:0;color:#fff;text-align:center}
...
.logo a{	background: url(images/logo.jpg) 0 0 no-repeat;width:500px;height:70px;border:none;cursor:pointer;display:inline-block; text-indent:-9999px; margin:40px 0 0 40px;padding:0;float:left}
.blogtitle a{color:#3ea8cf;font-size:22px;margin:40px 0px 0px 44px;padding:0;line-height:34px;display:block;font-weight:normal;text-transform:none;text-decoration:none;font-family:Trebuchet MS,sans-serif;letter-spacing:-1px}
...
#header ul.nav li a{color:#FFFFFF;display:block;font-family:Trebuchet MS,sans-serif;font-size:12px;padding:13px 20px 13px 18px;position:relative;text-decoration:none;text-shadow:0 1px 0 #666;text-shadow:0px 1px #000;background:url(images/nav-line.gif) no-repeat right}
...
.intro{width:880px;margin:5px auto 30px;font-family:Trebuchet MS,sans-serif;font-size:12px;line-height:30px; color:#757575;text-align:center}
...
.side-blok a{color:#666;text-decoration:none}
...
.sti-menu li a h2{color:#5b5b5b;font-family:Trebuchet MS,sans-serif;font-size:10px;line-height:28px;font-weight:normal;text-transform:uppercase;position:absolute;padding:10px;width:180px;top:170px;left:0px;}
...
.nivo-caption p {	padding:10px 10px 13px 25px;	margin:0;	font-size:12px;	line-height:26px;	font-family: Trebuchet MS, sans-serif; }
